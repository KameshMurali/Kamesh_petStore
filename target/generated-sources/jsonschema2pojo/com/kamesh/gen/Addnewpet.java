...
public class Addnewpet {
    ...
    public String toString() {
        ...
        sb.append(Addnewpet.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Addnewpet) == false) {
            return false;
        }
        Addnewpet rhs = ((Addnewpet) other);
